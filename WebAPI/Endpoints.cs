...
//        app.MapGet("/", () => Results.Redirect("/index.html"));
        ...
        app.MapGet("/books/{id:guid}",(IBookRepository bookRepoService, [FromRoute] Guid id, IMapper mapper) =>  bookRepoService.GetByIdAsync(id, mapper));
//        app.MapPost("/books", (IBookRepository bookRepoService, BookDto bookDto) => bookRepoService.AddAsync(bookDto));
        app.MapPost("/books", (IBookRepository bookRepoService, BookDto bookDto) => bookRepoService.AddAsync(bookDto));
...
//        app.MapGet("/authors/{id:guid}",(IAuthorRepository authorRepoService, [FromRoute] Guid id) =>  authorRepoService.GetByIdAsync(id));
        app.MapGet("/authors/{id:guid}",(IAuthorRepository authorRepoService, [FromRoute] Guid id, IMapper mapper) =>  authorRepoService.GetByIdAsync(id,  mapper));
